<?php
// Prueba de navegación y flujo completo del módulo de inventario de enseres
session_start();
...
echo "<h1>Prueba de Navegación - Módulo Inventario de Enseres</h1>";

echo "<h2>1. Verificación de Rutas</h2>";

$rutas = [
    'anterior' => '../estado_vivienda/estado_vivienda.php',
    'siguiente' => '../servicios_publicos/servicios_publicos.php',
    'dashboard' => [
...
$pasos = [
    ...
    'Paso 8' => 'Estado de Vivienda',
    'Paso 9' => 'Inventario de Enseres'
];

echo "<h3>Pasos del stepper:</h3>";
foreach ($pasos as $paso => $descripcion) {
    $estado = ($paso === 'Paso 9') ? 'active' : 'complete';
...
$campos = [
    'televisor_cant' => 'Televisores (select)',
    'dvd_cant' => 'DVDs (select)',
    'teatro_casa_cant' => 'Teatros en Casa (select)',
    'equipo_sonido_cant' => 'Equipos de Sonido (select)',
    'computador_cant' => 'Computadores (select)',
    'impresora_cant' => 'Impresoras (select)',
    'movil_cant' => 'Dispositivos Móviles (select)',
    'estufa_cant' => 'Estufas (select)',
    'nevera_cant' => 'Neveras (select)',
    'lavadora_cant' => 'Lavadoras (select)',
    'microondas_cant' => 'Microondas (select)',
    'moto_cant' => 'Motos (select)',
    'carro_cant' => 'Carros (select)',
...
echo "<p>El módulo de inventario de enseres está completamente integrado con:</p>";
echo "<ul>";
...
echo "<p>El módulo de inventario de enseres ha sido completamente refactorizado y está listo para usar.</p>";
?>
