...
<body class="bg-light">
        ...
        <div class="card mt-4 w-100" style="max-width:100%; border-radius: 0;">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST" id="formEstadoVivienda" novalidate autocomplete="off">
                    <!-- Fila 1: Estado de la Vivienda -->
                    <div class="row">
                        <div class="col-lg-6 col-md-6 mb-3">
                            <label for="id_estado" class="form-label required-field">
                                <i class="bi bi-clipboard-check me-1"></i>Estado de la Vivienda:
                            </label>
                            <select class="form-select" id="id_estado" name="id_estado" required>
                                <option value="">Seleccione</option>
                                <?php foreach ($opciones['estados'] as $estado): ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('formEstadoVivienda');
...
<head>
    ...
    <title>Estado de Vivienda - Dashboard Evaluador</title>
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="h3 mb-0">Estado de Vivienda</h1>
                            <p class="text-muted mb-0">Formulario de evaluación del estado de la vivienda</p>
                        </div>
                        <div class="text-end">
