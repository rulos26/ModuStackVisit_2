...
<body class="bg-light">
        ...
        <div class="card mt-4 w-100" style="max-width:100%; border-radius: 0;">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST" id="formTipoVivienda" novalidate autocomplete="off">
                    <!-- Fila 1: Tipo de Vivienda, Sector, Propietario -->
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-3">
                            <label for="id_tipo_vivienda" class="form-label required-field">
                                <i class="bi bi-house-door me-1"></i>Tipo de Vivienda:
                            </label>
                            <select class="form-select" id="id_tipo_vivienda" name="id_tipo_vivienda" required>
                                <option value="">Seleccione</option>
                                <?php foreach ($opciones['tipos_vivienda'] as $tipo): ?>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <label for="id_propietario" class="form-label required-field">
                                <i class="bi bi-person-badge me-1"></i>Propietario:
                            </label>
                            <select class="form-select" id="id_propietario" name="id_propietario" required>
                                <option value="">Seleccione</option>
                                <?php foreach ($opciones['propiedades'] as $propiedad): ?>
                    ...
                    <!-- Fila 2: Número de hogares, Personas núcleo familiar, Tiempo en sector -->
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-3">
                            <label for="numero_de_familia" class="form-label required-field">
                                <i class="bi bi-people me-1"></i>Número de hogares que habitan en la vivienda:
                            </label>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <label for="personas_nucleo_familiar" class="form-label required-field">
                                <i class="bi bi-person-lines-fill me-1"></i>Personas que conforman núcleo familiar:
                            </label>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <label for="tiempo_sector" class="form-label required-field">
                                <i class="bi bi-calendar-range me-1"></i>Tiempo en Residencia en el Sector:
                            </label>
                    ...
                    <!-- Fila 3: Número de pisos -->
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-3">
                            <label for="numero_de_pisos" class="form-label required-field">
                                <i class="bi bi-building me-1"></i>Número de Pisos de la Vivienda:
                            </label>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('formTipoVivienda');
            const camposObligatorios = [
                'id_tipo_vivienda', 'id_sector', 'id_propietario', 'numero_de_familia',
                'personas_nucleo_familiar', 'tiempo_sector', 'numero_de_pisos'
            ];
            ...
            function validarCampo(campo) {
                ...
                if (campo === 'numero_de_familia' || campo === 'personas_nucleo_familiar' || campo === 'numero_de_pisos') {
                    esValido = valor !== '' && !isNaN(valor) && parseInt(valor) > 0;
                } else {
...
<head>
    ...
    <title>Tipo de Vivienda - Dashboard Evaluador</title>
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="h3 mb-0">Tipo de Vivienda</h1>
                            <p class="text-muted mb-0">Formulario de información sobre el tipo de vivienda</p>
                        </div>
                        <div class="text-end">
