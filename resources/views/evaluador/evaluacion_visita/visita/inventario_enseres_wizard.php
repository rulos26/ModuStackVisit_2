...
require_once __DIR__ . '/inventario_enseres/InventarioEnseresController.php';
...
$wizard_step = 9;
$wizard_title = 'INVENTARIO DE ENSERES';
$wizard_subtitle = 'Registro de electrodomésticos y bienes del hogar';
$wizard_icon = 'fas fa-couch';
$wizard_form_id = 'formInventarioEnseres';
$wizard_form_action = '';
$wizard_previous_url = '../estado_vivienda_wizard.php';
$wizard_next_url = '../servicios_publicos/servicios_publicos.php';
?>

<link rel="stylesheet" href="../../../../../public/css/wizard-styles.css">
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
<style>
/* Estilos específicos para inventario de enseres */
.enseres-grid {
    display: grid;
        ...
        <div class="wizard-content">
            <div class="wizard-step-content active">
                ...
                <form action="<?php echo $wizard_form_action; ?>" method="POST" id="<?php echo $wizard_form_id; ?>" class="wizard-form" novalidate autocomplete="off">
                    <div class="enseres-grid">
                        <!-- Categoría: Entretenimiento -->
                        <div class="enseres-category">
                            <h6><i class="fas fa-tv me-2"></i>Entretenimiento</h6>
                            
                            <div class="enseres-item">
                        ...
                        <div class="enseres-category">
                            <h6><i class="fas fa-laptop me-2"></i>Tecnología</h6>
                        ...
                        <div class="enseres-category">
                            <h6><i class="fas fa-fire me-2"></i>Electrodomésticos</h6>
                        ...
                        <!-- Categoría: Vehículos -->
                        <div class="enseres-category">
                            <h6><i class="fas fa-car me-2"></i>Vehículos</h6>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateForm() {
        ...
        // Para inventario de enseres, todos los campos son opcionales
