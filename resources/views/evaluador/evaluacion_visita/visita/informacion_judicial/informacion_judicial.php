...
<head>
    ...
    <title>Información Judicial - Dashboard Evaluador</title>
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="h3 mb-0">Información Judicial</h1>
                            <p class="text-muted mb-0">Formulario de antecedentes judiciales y disciplinarios</p>
                        </div>
                        <div class="text-end">
