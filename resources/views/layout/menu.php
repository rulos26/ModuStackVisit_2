<div class="d-flex flex-column flex-shrink-0 p-3 bg-white border-end min-vh-100" style="width: 260px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="/resources/views/evaluador/carta_visita/index_carta.php" class="nav-link link-dark">
                <i class="bi bi-file-earmark-text me-2"></i>
                Carta de autorización
            </a>
        </li>
        <li>
            <a href="/resources/views/evaluador/evaluacion_visita/index_evaluacion.php" class="nav-link link-dark">
