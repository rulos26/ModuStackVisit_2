...
try {
    // Guardar la cédula en la sesión para que las vistas de evaluación puedan acceder a ella
    $_SESSION['cedula_evaluacion'] = $cedula;
    $_SESSION['id_cedula'] = $cedula;
    
    // También guardar información adicional que pueda ser útil
    $_SESSION['admin_viewing_evaluacion'] = true;
    $_SESSION['viewing_cedula_evaluacion'] = $cedula;
